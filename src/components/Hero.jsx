  ...
  return (
    <section className="relative min-h-[100svh] flex items-center overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 pt-24 sm:pt-28 pb-16 sm:pb-24 w-full">
        ...
        <p data-reveal style={{ '--reveal-delay': '90ms' }} className="text-lg sm:text-2xl text-slate-300 font-medium mb-3 sm:mb-4 max-w-2xl">
          Full-Stack Developer & CS Student at LAU
        </p>

        <p data-reveal style={{ '--reveal-delay': '160ms' }} className="text-slate-500 text-base sm:text-lg mb-10 sm:mb-12 max-w-xl">
          Based in Beirut, Lebanon.
        </p>

        <div data-reveal style={{ '--reveal-delay': '230ms' }} className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
          <a
        ...
        <div data-reveal style={{ '--reveal-delay': '300ms' }} className="grid grid-cols-1 sm:grid-cols-3 gap-7 sm:gap-10 mt-12 sm:mt-16 pt-10 sm:pt-16 border-t border-white/5">
